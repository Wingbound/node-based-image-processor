...
* 5 different processing nodes:
    * **Basic Nodes:**
        ...
        * Output Node: Saves processed images to disk, allows selection of output format and quality settings and displays a final image preview. [cite: 5]
    ...
    * **Intermediate Nodes:**
        * Blur Node: Implements Gaussian blur with configurable radius and uniform or directional blur options. [cite: 6]
